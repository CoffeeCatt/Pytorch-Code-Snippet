...
# Normal resnet: 224--112--56(before Resnet)--7(before pooling)--1--cls
# Cifar resnet: 32(change kernel/stride/padding from 7/2/3 to 3/1/1)--32(remove the maxpooling)(before Resnet)--4(before pooling)--1--cls
